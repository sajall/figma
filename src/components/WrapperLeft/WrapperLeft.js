        ...
        <>
            <div className="w-[77%] p-4 rounded-lg border border-gray-200 shadow-xl">
                ...
                <div className="bg-white border-b-[3px] border-gray-200 shadow-lg rounded-lg ">
                    ...
                    <div className="flex flex-wrap justify-between p-2 rounded-lg w-[100%] bg-red-400 ">
                        {/* select */}
                        <div className="flex gap-5 justify-start items-center bg-blue-400 w-[70%]">
                            <select className="w-[80%] h-[30px]">
                ...
                {/* animals story zoo */}
                <div className="w-[100%] flex flex-col gap-3  mt-4  bg-red-500 ">
                    {/* first child */}
                  


                    <div className="md:flex bg-green-500 gap-3">
    <div>
        <img src="zooProfile.png" alt="" />
    </div>
    {/* 2nd div */}
    <div className="p-4 border border-gray-200 rounded-lg shadow-md w-full md:w-[100%]">
        <div className="border-b-[2px] border-gray-300 w-full md:w-[100%] m-auto flex justify-between items-center">
        ...
        <div className="flex flex-wrap gap-3">
            ...
            <img src="card 4.png" alt="" className="cursor-pointer" />
                    ...
                    {/* second child */}
           <div className=" md:flex justify-between items-center w-[95%] ml-[5%] p-2  bg-blue-600">
                        <div className="flex gap-5">
                            <span className=" cursor-pointer font-bold text-sm bg-gradient-to-r from-blue-900 via-purple-900 to-purple-700 inline-block text-transparent bg-clip-text">
                                React
                            </span>
                        ...
                        <div className="md:flex flex-wrap text-gray-500 gap-4 items-center justify-between font-mono font-bold">
                            <span>29-March-2024 11:30 AM |</span>
                            <div className="flex gap-1">
                                <img
                                    src="Reactions.png"
                ...
                <div className="w-[100%] flex flex-col gap-3 ">
                    <div className="flex gap-3 h-[100%]">
                        <div className="flex flex-col h-[100%] ">
                            ...
                            <div className="h-[605px] w-[100%] ml-[50%] border-l-2 border-b-2 border-gray-200 rounded-b-lg"></div>
                        </div>
                        {/* 2nd div */}
                        <div className=" ">
                            <div className=" p-4 border border-gray-200 rounded-lg shadow-md">
                ...
                <div className="w-[100%] flex flex-col gap-3 ">
                    <div className="flex gap-3 h-[100%]">
                        <div className="flex flex-col h-[100%] ">
                            ...
                            <div className="h-[603px] w-[100%] ml-[50%] border-l-2 border-b-2 border-gray-200 rounded-b-lg"></div>
                        </div>
                        {/* 2nd div */}
                        <div className=" ">
                            <div className=" p-4 border border-gray-200 rounded-lg shadow-md">
