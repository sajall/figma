      ...
      <div className="w-[100%] flex flex-col gap-3 ">
        <div className="md:flex gap-3 h-[100%]">
          <div className="flex flex-col h-[100%] ">
            ...
            <div className="h-[605px] w-[100%] ml-[50%] border-l-2 border-b-2 border-gray-200 rounded-b-lg hidden lg:block"></div>
          </div>
          {/* 2nd div */}
          <div className=" ">
            <div className=" p-4 border border-gray-200 rounded-lg shadow-md">
              ...
              <div className=" flex-wrap justify-center md:flex ">
                <img
                  src="photo1.png"
                  alt=""
                  className="cursor-pointer w-[90%] md:w-[50%]"
                />
                <img
                  src="vid1.png"
                  alt=""
            ...
            <div className="md:flex justify-between items-center w-[100%] p-2">
