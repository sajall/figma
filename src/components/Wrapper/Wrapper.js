    ...
    <>
      <div className="mt-[30px] ">
        ...
        <div className="flex w-[95%]  m-auto gap-5 mt-10 rounded-lg p-4 ">
          {/* left */}
          <div className="w-[90%] p-4 rounded-lg border border-gray-200 shadow-xl">
            {/* comments */}
                ...
                <div className="flex  justify-center items-center  gap-3">
                  <div className="flex ">
                    <div className="border-gradient h-[30px] w-[30px] rounded-md">
                      <img src="arrow-up.png" alt=""  className="cursor-pointer" />
                    </div>
                    <div className="border-gradient h-[30px] w-[30px]  rounded-md">
                      <img
                        src="arrow-down.png"
            ...
            <div className="flex flex-col justify-center rounded-lg border-2 border-gray-200 shadow-md mt-2">
              <div className="flex gap-3 p-2 rounded-lg">
                <img src="Proflile Type.png" alt=""  className="cursor-pointer" />
                <input
                  type="text"
              ...
              <div className="flex items-center justify-between py-1 w-[98.5%] m-auto">
                ...
                <div className="flex justify-center items-center gap-2 ">
                  ...
                  <div>
                    <img src="Send Message.png" alt="" className="cursor-pointer" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className=" p-4 border border-gray-200 rounded-lg shadow-md">
                ...
                <div className="flex items-center justify-between ">
                  <span className="text-gray-500 font-semibold" >
                    Ut sit nunc egestas ante. Dictum arcu eget eros ac. Duis ut
                    malesuada ut lacus.
                  </span>
                  <img
                ...
                <div>
                  <img src="vedioPlayer.png " alt="" className="cursor-pointer" />
                </div>
                ...
                <div className="flex justify-between items-center w-[95%] ml-[5%] p-2 border-b-2 border-gray-200">
                  ...
                  <div className="flex text-gray-500 gap-4 items-center justify-center font-mono font-bold">
                    ...
                    <div className="flex gap-1">
                      <img src="Reactions.png" alt="" className="cursor-pointer h-[20px]"  />
                      <span>100</span>
                    </div>
                    <div className="flex">
                      <img src="replies.png" alt="" className="cursor-pointer h-[20px]"  />
                      <span>0</span>
                    </div>
                  </div>
                </div>
            ...
            {/* Dr. Ahmad Hassan */}
            <div className="w-[100%] h-[38%] mt-4 bg-blue-900">              
              <div className="flex gap-3">
              <div className="flex flex-col h-[100%] bg-yellow-600">
                <img src="Proflile Type.png" alt="" className="w-[70px]"  />
                <div className="h-[100%] w-[100%] bg-green-600 ml-[50%]"></div>
              </div>
              {/* 2nd div */}
              <div className=" ">
              <div className=" p-4 border border-gray-200 rounded-lg shadow-md  bg-gray-500 ">
                <div className="border-b-[2px] border-gray-300 w-[100%] m-auto flex justify-between items-center">
                ...
                <div className="flex items-center justify-between ">
                  ...
                  Ut purus pretium nibh fringilla cursus adipiscing odio vitae.
                   Vehicula amet elit libero mauris ac sit nisl amet iaculis elementum.
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center w-[100%] p-2 border-b-2 border-gray-200 bg-red-700">
                  <div className="flex gap-5">
                    <span className=" cursor-pointer font-bold text-sm bg-gradient-to-r from-blue-900 via-purple-900 to-purple-700 inline-block text-transparent bg-clip-text">
                      React
                    </span>
