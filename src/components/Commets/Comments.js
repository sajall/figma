  ...
  return (
    <>
      ...
      <div className="bg-white border-b-[3px] border-gray-200 shadow-lg rounded-lg ">
        ...
        <div className="flex flex-wrap justify-between p-2 rounded-lg w-[100%]  ">
          {/* select */}
          <div className="flex gap-5 items-center w-[90%] sm:w-[40%]  ">
            <select className=" w-[80%] sm:w-[70%] h-[30px]">
          ...
          {/* arrows */}
          <div className="flex items-center  gap-3 w-[98%] sm:w-[20%]">
            <div className="w-[50%] flex sm:w-[30%] ">
            ...
            <button className="bg-purple-600 rounded-3xl px-2 text-white w-[90%] h-[35px] sm:w-[50%]">
              100 Results
            </button>
          </div>
        </div>
      ...
      <div className="flex flex-col justify-center rounded-lg border-2 border-gray-200 shadow-md mt-2">
        ...
        <div className=" flex-wrap md:flex items-center justify-between py-1 w-[98.5%] m-auto">
          <span className="ml-[6%] text-gray-500">0/5k characters</span>
          {/* all icons along with send button */}
      ...
      {/* please write your comment here ended */}
    </>
  );
};
